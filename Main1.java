...
public class Main1 {
  ...
  public static void main(String[] args) {
    ...
    if(input.equals("e")){
      ...
      try {
        ...
        for(int i=1;i<=numProcess;i++){
          ...
          String numCycle = in.nextLine();
          info = info+" "+numCycle;
          if(Integer.parseInt(numCycle)!=1){
            ...
            if(answer.equals("n")){info = info + " -1";}
              ...
              String cycletime = in.nextLine();
              while (Integer.parseInt(cycletime)>Integer.parseInt(numCycle)||Integer.parseInt(cycletime)<=0){     
                
                System.out.println("Cycle time cannot be greater than the number of cycles."); 
                System.out.println("Please enter an integer between 1 and "+numCycle+".");
                cycletime = in.nextLine();
    ...
    // the following code is from pcb main method
    ...
    while(!(menu.equals("exit"))){
      ...
      if(menu.equals("1")){
        ...
        //update a process
        //System.out.println("Enter the ID of the process you want to update: ");
        //int pID = Integer.parseInt(in.nextLine());
        System.out.println("This code still needs some work.");
      }
